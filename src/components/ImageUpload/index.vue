...
var cos = new COS({
    SecretId: 'AKID97pGRKwHMAizzjCOJxKPDl10i8IAlLfi', // 身份识别 ID
    SecretKey: 'nJYXFgqjLgkZ6ML4XicEagU1HGxOXQ3P', // 身份密钥
});
//  action = “#”  就不会报错 
//  file-list 是上传的文件列表  可以绑定到上传组件上 让上传组件来显示
    ...
    upload(params) {
      if (params.file) {
        ...
        cos.putObject({
          // 配置
          Bucket: 'zhongtai-1309749758', // 存储桶名称
